...
import { Share2, Users, ArrowUpRight, Copy, ArrowLeft } from './Icons';
...
const Referral: React.FC<ReferralProps> = ({ referralCode, earnings, onNavigate }) => {
  ...
  return (
    <div className="space-y-6 pb-24 animate-fade-in font-chakra">
       <div className="flex items-center gap-4 mt-4">
         ...
         <h2 className="text-2xl brand-font text-white uppercase italic">Refer & Earn</h2>
       </div>
